...
/*   Updated: 2019/09/05 12:45:09 by pheilbro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	parse_md_stdin(t_ssl_context *c)
{
	...
	file->fd = 0;
	file->file_name = NULL;
	file->stdin_data = ft_dstr_release(s);
...
void	parse_message_digest(t_ssl_context *c, char **data, int len, int *i)
{
