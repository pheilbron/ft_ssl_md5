...
/*   Updated: 2019/09/06 12:13:10 by pheilbro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_ssl_sha512_224(char *data, uint32_t **file_hash);
void			ft_ssl_sha512_256(char *data, uint32_t **file_hash);

uint64_t		sha512message_schedule_sum(uint64_t message_schedule[80],
